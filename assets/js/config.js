...
export const KNOWN_CONTRACTS = {
  ...
  '0xacace2b290334e45f2db8bd819bb4b6868477777': { name: 'Protocol Treasury', kind: 'account', tag: 'treasury', note: 'Receives 50% of the base fee every block collects from block 1,969,200 (fee floor + split switch)' },
